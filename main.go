...
func main() {
	...
	fmt.Printf("[INFO] toy: run_done keys=%d processed=%d capped=%d invalid=%d total_spent=%d capped_cost=%d\n",
		s.Keys, s.Processed, s.Capped, s.Invalid, s.TotalSpent, s.CappedCost)
}
